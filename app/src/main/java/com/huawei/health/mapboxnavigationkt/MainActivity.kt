...
class MainActivity : AppCompatActivity(), OnNavigationReadyCallback, NavigationListener {
    ...
    override fun onNavigationReady(isRunning: Boolean) {
        if (!isRunning && !::navigationMapboxMap.isInitialized) {
            val origin: Point = Point.fromLngLat(114.07794, 22.532425)
            val destination: Point = Point.fromLngLat(114.106854, 22.543012)
